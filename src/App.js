  ...
  return (
    <section id="home" className="min-h-screen bg-blue-900 text-white flex items-center justify-center py-16">
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg mb-8">Cyberjam 2024 is an immersive hackathon taking place from October 19th to October 27th at Chicago's 1871. Teams of 5 will work together on phygital experiences combining art, technology, and innovation across five thematic tracks: Governance, Fashion, Security & Privacy, Sports & Gaming, and AI.</p>
